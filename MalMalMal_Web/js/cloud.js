...
//	Adjusting offsets to be at the center
	...
	Cloud.addBindings =function(tag) {
		...
		tag.group.on('mouseenter',function(e){
			...
			//popup setting
			var temp = "뉴스수 : "+tag.newscount+"<br>";
						//temp+="발언수 : "+tag.SpeakingCnt+"<br>";
						temp+="댓글수 : "+tag.commentcnt+"<br>";
						temp+="좋아요 : "+tag.likescnt+"&nbsp;&nbsp;&nbsp;";
						temp+="싫어요 : "+tag.unlikescnt+"<br>";
        ...
        success: function(jdata,data){           //성공시 처리 함수, 인수는 위에서 data를 사용한 경우
						...
						//console.log(e.clientY+10+" "+e.clientX+20);
		...
		tag.group.on('mouseleave',function(){
			if(ajaxCloudCall)ajaxCloudCall.abort();
			document.body.style.cursor = 'default';
			Cloud.hoverColor(this,tag.defcolor);
			if(tag.related[0]!="null"){
